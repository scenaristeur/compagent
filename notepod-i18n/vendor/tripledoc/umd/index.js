(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function initialiseSubject(document, subjectRef) {
        var subjectNode = isBlankNode(subjectRef) ? subjectRef : n3.DataFactory.namedNode(subjectRef);
        ...
        var getLocalSubject = function (predicateRef) {
            var objects = get(predicateRef);
            var firstRef = objects.find(isBlankNode);
        ...
        var getAllLocalSubjects = function (predicateRef) {
            var objects = get(predicateRef);
            var nodeRefs = objects.filter(isBlankNode);
        ...
        var asRef = function () { return isBlankNode(subjectRef) ? subjectRef.id : subjectRef; };
        var subject = {
     ...
     * @returns Whether `param` is an N3 string Literal.
     */
    function isStringLiteral$1(param) {
        return isLiteral$1(param) && param.datatype.id === 'http://www.w3.org/2001/XMLSchema#string';
    }
    /**
     * @ignore Tripledoc's methods should be explicit about whether they return or accept a specific
     *         type, so this is merely an internal utility function, rather than a public API.
     ...
     * @returns Whether `param` is an N3 integer Literal.
     */
    function isIntegerLiteral$1(param) {
        return isLiteral$1(param) && param.datatype.id === 'http://www.w3.org/2001/XMLSchema#integer';
    }
    /**
     * @ignore Tripledoc's methods should be explicit about whether they return or accept a specific
     *         type, so this is merely an internal utility function, rather than a public API.
     ...
     * @returns Whether `param` is an N3 decimal Literal.
     */
    function isDecimalLiteral$1(param) {
        return isLiteral$1(param) && param.datatype.id === 'http://www.w3.org/2001/XMLSchema#decimal';
    }
    /**
     * @ignore Tripledoc's methods should be explicit about whether they return or accept a specific
     *         type, so this is merely an internal utility function, rather than a public API.
     ...
     * @returns Whether `param` is an N3 DateTime Literal.
     */
    function isDateTimeLiteral$1(param) {
        return isLiteral$1(param) && param.datatype.id === 'http://www.w3.org/2001/XMLSchema#dateTime';
    }
    /**
     * @ignore Deprecated function.
     * @deprecated Replaced by [[isReference]].
     */
    var isNodeRef = isReference$1;
    /**
     * @ignore Tripledoc's methods should be explicit about whether they return or accept a [[Reference]],
     *         so this is merely an internal utility function, rather than a public API.
     * @param param A value that might or might not be a reference to a node in the Linked Data graph.
    ...
    function isReference$1(value) {
        return typeof value === 'string' && !isLiteral$1(value);
    }
    /**
     * @ignore Blank Nodes themselves should not be exposed to library consumers, so this is merely an
     *         internal utility function, rather than a public API.
    ...
    exports.isBlankNode = isBlankNode$2;
    exports.isDateTimeLiteral = isDateTimeLiteral$1;
    exports.isDecimalLiteral = isDecimalLiteral$1;
    exports.isIntegerLiteral = isIntegerLiteral$1;
    exports.isLiteral = isLiteral$1;
    exports.isNodeRef = isNodeRef;
    exports.isReference = isReference$1;
    exports.isStringLiteral = isStringLiteral$1;
